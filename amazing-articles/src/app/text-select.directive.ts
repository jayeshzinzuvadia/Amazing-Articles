...
export class TextSelectDirective implements OnInit, OnDestroy {
  ...
  // Initialize the text-select directive.
  constructor(
  ...
  // PUBLIC METHODS.
  // This method get called once when the directive is being unmounted.
  ...
  // This method get called once after the inputs have been bound for the first time.
  ...
  // This method get the deepest Element node in the DOM tree that contains the entire range.
  ...
  // This handles mousedown events inside the current element.
  private handleMousedown = (): void => {
    document.addEventListener("mouseup", this.handleMouseup, false);

  }

  // This handles mouseup events anywhere in the document.
  ...
  // This handle selectionchange events anywhere in the document.
  ...
  // This will determine if the given range is fully contained within the host element.
